...
public class DataProcessor implements IDataProcessor {
    ...
    private List<Data> convert(IPAddress ipAddress, int port) {
        if (dataReader.isServerAvailable(ipAddress, port)) {
            String jsonData = dataReader.getSensorsData(ipAddress, port);
    ...
    public List<Data> getData() {
        return convert(dataReader.getIPAddress(), dataReader.getPort());
    }
}
